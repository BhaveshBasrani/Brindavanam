      ...
      <AnimatePresence>
        {mobileSearchOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="w-full px-4 pb-3 sm:hidden"
          >
            <div className="relative flex items-center">
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
                autoFocus
                className="w-full pl-9 pr-8 py-2.5 text-xs border border-stone-300 rounded-xl bg-white focus:outline-none focus:border-[#3A5303]"
              />
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="w-full px-4 pb-4 md:hidden"
          >
            <div className="p-5 rounded-3xl bg-white border border-stone-200 shadow-xl space-y-4">
